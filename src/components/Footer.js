  ...
  return (
      <footer className="footer-container">
        ...
        <div className="social-icons">
          <a href="mailto:satechstudios@gmail.com" target="_blank" rel="noopener noreferrer"><FaEnvelope className="icon" /></a>
          ...
          <a href="https://www.linkedin.com/company/satech-studios/" target="_blank" rel="noopener noreferrer"><FaLinkedin className="icon" /></a>
          ...
          <a href="https://wa.me/7558197152" target="_blank" rel="noopener noreferrer"><FaWhatsapp className="icon" /></a>
